...
Stream your training session to a shared global game map using the [Broadcast Wrapper](/common/stream_agent_wrapper.py)
...
### Training Broadcast
Stream your training session to a shared global game map using the [Broadcast Wrapper](/common/stream_agent_wrapper.py) on your environment like this:
```python
env = StreamWrapper(
            env, 
