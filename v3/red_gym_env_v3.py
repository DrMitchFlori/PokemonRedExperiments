...
from .event_utils import scan_event_flags
...
class RedGymEnv(Env):
    ...
    def reset(self, seed=None, options={}):
        ...
        self.update_current_event_flags()
    ...
    def step(self, action):
        ...
        # periodically update map of all active event flags
    ...
    def update_current_event_flags(self):
        """Scan memory for currently set event flags."""
        self.current_event_flags_set = scan_event_flags(
            self.read_m,
            self.event_names,
            event_flags_start,
            event_flags_end,
